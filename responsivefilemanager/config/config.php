...
$config = [
    ...
    */
    ...
    'access_keys' => ['bce94f94426497ba5e669a705c186f12', '7969d6a7b4697750ebdcdd018274d571', '48607dfdaf9aba9b83f3dc881a939f68'],
    ...
    */
    ...
    'relative_path_from_current_pos'          => ['../../data/thumbs/', '../../data/thumbs/'], //relative path of the image folder from the current position on upload folder
    'relative_image_creation_name_to_prepend' => ['', ''], //name to prepend on filename
    'relative_image_creation_name_to_append'  => ['_thumb', '.thumbnail'], //name to append on filename
